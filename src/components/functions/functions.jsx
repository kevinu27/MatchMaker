...
// export function getNumberOfPlayers(event) {
//   setNumberOfPlayers(event.target.value);
// }

// export const matchResult = (e, id) => {
//   if (e.target.value !== "") {
...
// export const matchResult2 = (e, id) => {
//   if (e.target.value !== "") {
//     const matchesCopy = [...matchesState];
//     const pointsToPush = parseInt(e.target.value);
//     const playersScoring = matchesCopy.find((match) => match.id === id);
...
// export const setPlayerName = (playerId, playerName) => {
//   const playersCopy = [...players];
//   const playerToChange = playersCopy.find((player) => player.id === playerId);
...
// export function totalEachPlayersPoints(id) {
